...
class TreeNode extends React.Component {
    ...
    onCheck() {
        const { value,data, onCheck } = this.props;

        onCheck({ value,data, checked: this.getCheckState({ toggle: true }) });
    ...
    onExpand() {
        const { expanded, value,data, onExpand } = this.props;

        onExpand({ value,data, expanded: !expanded });
    }
