...
import NodeModel from './js/NodeModel';
import TreeNode from './js/TreeNode';
import iconsShape from './js/shapes/iconsShape';
import languageShape from './js/shapes/languageShape';
import listShape from './js/shapes/listShape';
import nodeShape from './js/shapes/nodeShape';
...
class CheckboxTree extends React.Component {
    ...
    onCheck(nodeInfo) {
        ...
        let children=model.getChildren(node.data);

        onCheck(model.serializeList('checked'), { ...node, ...nodeInfo },children);
    }
